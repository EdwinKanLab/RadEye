...
int main(){
    ...
    Cropper topLeftRegion(0, 0.10, 0.0, 0.15);
    Cropper topRightRegion(0.05, 0.15, 0.80, 1);
    Cropper bottomLeftRegion(0.85, 0.98, 0, 0.20);
    Cropper bottomRightRegion(0.85, 1, 0.85, 1);
